...
<head>
	...
	<script src="js/uang.js" type="text/javascript"></script>
	<script src="js/waypoints.js" type="text/javascript"></script>
    <link href="https://fonts.googleapis.com/css?family=Dosis" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Lobster" rel="stylesheet">
    <title>HolyShirt | Upload</title>
...
<body>
    <nav class="navbar navbar-expand-sm navbis">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a href="/" class="navbar-brand">HolyShirt</a>
            </li>
        </ul>
    ...
    <div class="container-fluid" id="regist">
        <div class="row">
            <div class="col-sm-12  os-animation"data-os-animation="bounceInUp" data-os-animation-delay="0s">
                <h3>UPLOAD YOUR ITEM</h3>    
                
                <h4>HolyShirt</h4>
                <form action="">
                    <div class="form-group d-flex justify-content-center">
                        <input type="namabarang" class="form-control" id="namabarang" placeholder="Nama Barang" name="firstname">
                    </div>
                </form>
                <form action="">
                    <div class="form-group d-flex justify-content-center">
                         <select class="form-control" name="kategori">
                             <option value="Kategori" disabled selected='select'>-Kategori-</option>
                ...
                <form action="">
                    <div class="form-group d-flex justify-content-center">
                        <input type="warna" class="form-control" id="warna" placeholder="Warna Barang" name="warna">
                    </div>
                </form>
                <form action="" >
                    <div class="form-group d-flex justify-content-center">
                       <input input type="file" class="form-control" id="gambar">
                    </div>
                </form>
                <form action="">
                    <div class="form-group d-flex justify-content-center">
                        <input type="harga" class="form-control" id="harga" placeholder="Harga Barang" name="harga">
                    </div>
                </form>
                <a href="/verification" ><button type="button" class="btn"  >Submit</button></a>
            </div>
        </div>
    </div>
