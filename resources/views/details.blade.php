...
<body>
    <nav class="navbar navbar-expand-sm navbis">
        ...
        <ul class="navbar-nav mx-auto">
            <li class="nav-item">The Joy of Fashion is an rt</li>
        </ul>
        <ul class="navbar-nav justify-content-end" id="right">
            <li class="nav-item ml-auto">
                <a href="/login" class="nav-link" id="active">LOGIN</a>
            </li>
        </ul>
    </nav>  
    <div class="container justify mx-auto" style="padding: 0;;margin: 0">
       <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <br>
                <br>
                <button type="button" class="btn">Orded Now</button>
    ...
    <div class="container-fluid" id="footer" style="margin-top: 0">
